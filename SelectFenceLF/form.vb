...
Private Sub CommandButton1_Click()
    ...
    'if activemodelreference.
     ...
     tEnum = ActiveModelReference.GetSelectedElements
...
Private Sub getTrfStats_Click()
    ...
    If validFenceDefined Then
        ...
        selectTRFRzoneShapes
         trfrZoneEnum = ActiveModelReference.GetSelectedElements 'ActiveDesignFile.Fence.GetContents
        trfrZoneEnum.Reset
        ...
        Do While trfrZoneEnum.MoveNext
            ...
            ' 3. Get TRFR Cell text
             trfrCellEnum = ActiveModelReference.GetSelectedElements
            ...
            selectConductor ("Service Cable")
             serviceCableEnum = ActiveModelReference.GetSelectedElements
